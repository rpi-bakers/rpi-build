...
#------------------------------------------------------------------------------
SRC_DIR=$(pwd)
source poky/oe-init-build-env "$MANIFEST_VER-build"
...
echo "[rpi-setup] run the source oe-init-build-env command to set up the bitbake environment."
echo "[rpi-setup] source ../poky/oe-init-build-env"
